...
import 'package:gofit_mobile_frontend/screen/member/addClass.dart';
import 'package:gofit_mobile_frontend/screen/member/addGym.dart';
import 'package:gofit_mobile_frontend/data/userLogin.dart';
import 'package:gofit_mobile_frontend/screen/member/addKelas.dart';
...
class pindahMember {
  static void cekPindah(BuildContext context, int selectedIndex) {
    if (selectedIndex == 0) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AddBookClass()),
      );
